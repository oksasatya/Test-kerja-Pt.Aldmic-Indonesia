                            ...
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="password" class="form-control" id="password-confirm"
                                        name="password_confirmation" placeholder="Konfirmasi password baru Anda" required />
                                ...
                                <button type="submit" class="btn btn-orange radius-default w-100 text-white mt-4">Ubah
                                    Password</button>
                            </form>
